...
class _SplashScreen extends State<SplashScreen> {
  ...
  Settings settings = Settings.fromSettings({'url': '${GlobalConfiguration().getString('base_url')}'});
  ...
  Future<void> initOneSignal() async {
    ...
    await OneSignal.shared
        .init('${GlobalConfiguration().getString('appIdOneSignal')}', iOSSettings: settings);
